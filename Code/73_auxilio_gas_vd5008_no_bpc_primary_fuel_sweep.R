...
out_dir <- here("data", "powerIV", "regressions", "auxilio_gas_vd5008_no_bpc_primary_fuel_sweep")
...
households <- read_parquet(
  ...
  mutate(
    ...
    has_bpc_visit1 = coalesce(has_bpc_visit1, 0L),
    has_bolsa_visit1 = coalesce(has_bolsa_visit1, 0L),
    eligible_vd5008_only = !is.na(vd5008_pc) & !is.na(half_min_wage) & vd5008_pc <= half_min_wage,
    eligible_vd5008_only_no_bpc = !is.na(vd5008_pc) & !is.na(half_min_wage) & vd5008_pc <= half_min_wage & has_bpc_visit1 == 0,
    eligible_vd5008_bolsa_no_bpc = !is.na(vd5008_pc) & !is.na(half_min_wage) & vd5008_pc <= half_min_wage & has_bolsa_visit1 == 1 & has_bpc_visit1 == 0,
...
household_samples <- tibble::tribble(
  ~sample, ~filter_expr,
  "all_households", "TRUE",
  "eligible_vd5008_only_households", "eligible_vd5008_only == TRUE",
  "eligible_vd5008_only_no_bpc_households", "eligible_vd5008_only_no_bpc == TRUE",
  "eligible_vd5008_bolsa_no_bpc_households", "eligible_vd5008_bolsa_no_bpc == TRUE"
)
...
sample_defs <- tibble::tribble(
  ~sample, ~filter_expr,
  "all_women", "TRUE",
  "eligible_vd5008_only", "eligible_vd5008_only == TRUE",
  "eligible_vd5008_only_no_bpc", "eligible_vd5008_only_no_bpc == TRUE",
  "eligible_vd5008_bolsa_no_bpc", "eligible_vd5008_bolsa_no_bpc == TRUE"
)
...
paper_table_households <- household_results %>%
  filter(
    sample %in% c("all_households", "eligible_vd5008_only_households", "eligible_vd5008_only_no_bpc_households", "eligible_vd5008_bolsa_no_bpc_households"),
  ...
  transmute(
    ...
    sample_label = case_when(
      ...
      sample == "eligible_vd5008_only_households" ~ "VD5008 households",
      sample == "eligible_vd5008_only_no_bpc_households" ~ "VD5008 households, no BPC",
      sample == "eligible_vd5008_bolsa_no_bpc_households" ~ "VD5008 + Bolsa households, no BPC",
      TRUE ~ sample
    ),
    outcome,
...
paper_table_women <- cross_results %>%
  filter(
    sample %in% c("all_women", "eligible_vd5008_only", "eligible_vd5008_only_no_bpc", "eligible_vd5008_bolsa_no_bpc"),
  ...
  transmute(
    ...
    sample_label = case_when(
      ...
      sample == "eligible_vd5008_only" ~ "VD5008 women",
      sample == "eligible_vd5008_only_no_bpc" ~ "VD5008 women, no BPC",
      sample == "eligible_vd5008_bolsa_no_bpc" ~ "VD5008 + Bolsa women, no BPC",
      TRUE ~ sample
    ),
    outcome,
...
paper_table <- bind_rows(paper_table_households, paper_table_women) %>%
  mutate(
    ...
    sample %in% c("all_households", "all_women") ~ 1L,
      sample %in% c("eligible_vd5008_only_households", "eligible_vd5008_only") ~ 2L,
      sample %in% c("eligible_vd5008_only_no_bpc_households", "eligible_vd5008_only_no_bpc") ~ 3L,
      sample %in% c("eligible_vd5008_bolsa_no_bpc_households", "eligible_vd5008_bolsa_no_bpc") ~ 4L,
      TRUE ~ 5L
    ),
