...
out_dir <- here("data", "powerIV", "regressions", "auxilio_gas_monthly_glp_event_study")
...
price_monthly <- read_parquet(here("data", "powerIV", "prices", "anp_lpg_monthly_uf_2016_2024.parquet")) %>%
  transmute(
    uf_sigla,
    year,
    month,
...
plot_specs <- tribble(
  ...
  "log_glp_p13_sales", "people", "M2", "monthly_event_study_log_glp_p13_sales_auxgas_with_price", "Monthly GLP P13 Sales and Auxilio Gas Top-Up", "Adds monthly UF LPG price control; sample ends in 2024-12"
)
